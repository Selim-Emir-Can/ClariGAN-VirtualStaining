...
from runners.DiffusionBasedModelRunners import BBDMRunner_trainable_encoder
...
if __name__ == "__main__":
    ...
    sys.argv = [
        ...
        "--config", r"C:\Users\ammic\Desktop\ClariGAN-DL\BBDM\configs\Template-LBBDM-f16_imagenetVQGAN_finetuned_trainable_encoder.yaml", # change it to your config file path
        "--train",
        "--sample_at_start",
        "--save_top",
        "--gpu_ids", "0"]
