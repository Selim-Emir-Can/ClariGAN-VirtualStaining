...
def get_dataset(data_config, train_set=None, val_set=None, test_set=None):
    if(train_set is None):
        ...
        train_dataset = Registers.datasets[data_config.dataset_type](data_config.dataset_config, stage='train', split_set=train_set)
        val_dataset = Registers.datasets[data_config.dataset_type](data_config.dataset_config, stage='val', split_set=val_set)
        test_dataset = Registers.datasets[data_config.dataset_type](data_config.dataset_config, stage='test', split_set=test_set)
