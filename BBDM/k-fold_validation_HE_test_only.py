...
if __name__ == "__main__":
    splits = stratified_kfold_85_5_10(r"C:\Users\ammic\Downloads\train400\train", k=10) # change the path to BBDM dataset train directory
    ...
    for fold in splits:
        ...
        nconfig.data.dataset_config.dataset_path = r"C:\Users\ammic\Downloads\train400\train" # change the path to BBDM dataset train directory
        ...
        base_path = r"C:\Users\ammic\Desktop\ClariGAN-DL\BBDM\Brian_v1" # WHERE YOU HAVE YOUR MODEL WEIGHTS change this to where you want to save your results
        dataset_name = nconfig.data.dataset_name
        try:
            ckpt_path = find_latest_ckpt(base_path, dataset_name+'_'+save_name)
        except:
            counter = counter + 1
            continue
        ...
        sample_path = os.path.join(r"C:\Users\ammic\Desktop\ClariGAN-DL\BrianHE_k-fold_results\Brian_v1", save_name) # WHERE YOU HAVE TEST RESULTS FOR EACH FOLD of the k-fold cross validation
