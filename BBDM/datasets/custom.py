...
from datasets.custom_dataset import ImagePathDatasetCustom
...
class CustomAlignedDataset(Dataset):
    def __init__(self, dataset_config, stage='train'):
        ...
        self.imgs_ori = ImagePathDatasetCustom(image_paths=image_paths_ori, image_size=self.image_size, flip=self.flip, augmentations=self.flip, to_normal=self.to_normal)
        self.imgs_cond = ImagePathDatasetCustom(image_paths=image_paths_cond, image_size=self.image_size, flip=self.flip, augmentations=self.flip, to_normal=self.to_normal)
