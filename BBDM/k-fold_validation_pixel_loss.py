...
from runners.DiffusionBasedModelRunners import BBDMRunner_pixel_loss
...
if __name__ == "__main__":
    ...
    sys.argv = [
        ...
        "--config", r"C:\Users\ammic\Desktop\ClariGAN-DL\BBDM\configs\Template-LBBDM-f16_imagenetVQGAN_finetuned_pixel_loss.yaml", # change it to your config file path
        "--train",
        "--sample_at_start",
        "--save_top",
        "--gpu_ids", "0"]
    ...
    for fold in splits:
        ...
        save_name = f'fold_{counter}_pixel_loss'
        ...
        sample_path = os.path.join(r"C:\Users\ammic\Desktop\ClariGAN-DL\k-fold_results_pixel_loss", save_name) # WHERE YOU HAVE TEST RESULTS FOR EACH FOLD of the k-fold cross validation
