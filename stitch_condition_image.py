...
condition_folder = os.path.join(parent_folder, 'condition')
part_num = 0
letter = "Z"
...
# final_condition_image_path = os.path.join(parent_folder, f"part{part_num}_stitched_condition_image.png")
final_condition_image_path = os.path.join(parent_folder, r"stitched_condition_image.png")
