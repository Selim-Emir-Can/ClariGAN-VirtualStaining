...
conda activate taming
cd C:\Users\ammic\Desktop\ClariGAN-DL\taming-transformers
python main.py --base C:\Users\ammic\Desktop\ClariGAN-DL\taming-transformers\configs\custom_vqgan_f16_imagenet_BF.yaml --name BF_HE_finetuneV4 --resume_from_checkpoint C:\Users\ammic\Desktop\ClariGAN-DL\taming-transformers\logs\2025-12-11T00-52-48_BF_HE_finetuneV3\checkpoints\epoch=000026-val_rec_loss-val_loss=0.0000.ckpt -t True --gpus 0,
